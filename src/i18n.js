...
const LABELS = {
  EN: {
    ...
    reminderHeader: (timeStr) => `🔔 <b>Reminder!</b> Event starts in <b>10 minutes</b> (at ${timeStr}) 🎮`,
    soon: "soon",
  ...
  UA: {
    ...
    reminderHeader: (timeStr) => `🔔 <b>Нагадування!</b> Подія починається через <b>10 хвилин</b> (в ${timeStr}) 🎮`,
    soon: "скоро",
