...
const result: MatchResult = {
  ...
  rows: [
    ...
    row(1, "Transend", 1.53, 3.1, "21/14/3", "98.6", 1679, 24),
    row(2, "kiko", 1.24, 0.4, "19/15/9", "94.1", 1802, 23),
    row(3, "Booyaaa", 0.86, -2.7, "14/17/6", "71.3", 1497, -23),
    row(4, "Zandy", 0.71, -4.5, "11/18/8", "63.2", 1318, -22),
  ],
};
